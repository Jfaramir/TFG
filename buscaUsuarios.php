...
<html>
    ...
    <script>
        ...
        for (i = 0; i < numUsuarios; i++) {
            $("#usuariosbusca").append(' <a id="us'+listaUsuarios[i][0]+'" class="list-group-item list-group-item-action bg-dark " on     click="añadeUsuario('+ listaUsuarios[i][0] +','+"'"+listaUsuarios[i][3] +"'"+')">' + listaUsuarios[i][3] + '</a>');
