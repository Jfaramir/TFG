...
function muestra() {
        for (i = 0; i < numGrupos; i++) {
            $("#cajaGrupo").append(' <a id="grupo' + listaGrupos[i][0] + '" class="list-group-item list-group-item-action  " style="margin-top: 5px;cursor:pointer; background-color: #E67073" onclick="cargaTareas('+ listaGrupos[i][0] +','+"'"+listaGrupos[i][1] +"'"+')">' + listaGrupos[i][1] + '</a>');
